...
const LoginForm: React.FC<TLoginFormProps> = ({ onSubmit, startupConfig, error, setError }) => {
  ...
  return (
    <>
      {showResendLink && (
        <div className="mt-2 rounded-md border border-brand-green-500 bg-brand-green-500/10 px-3 py-2 text-sm text-gray-600 dark:text-gray-200">
      ...
      >
        <div className="mb-4">
          <div className="relative">
            ...
            <label
              htmlFor="email"
              className="absolute start-3 top-1.5 z-10 origin-[0] -translate-y-4 scale-75 transform bg-surface-primary px-2 text-sm text-text-secondary-alt duration-200 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-1.5 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-brand-green-600 dark:peer-focus:text-brand-green-500 rtl:peer-focus:left-auto rtl:peer-focus:translate-x-1/4"
            >
              {useUsernameLogin
